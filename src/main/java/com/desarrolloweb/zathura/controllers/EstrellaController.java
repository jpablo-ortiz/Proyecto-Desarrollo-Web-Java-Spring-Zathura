...
public class EstrellaController {
	...
	@Autowired
	private EstrellaService service;

	@RequestMapping
	public String obtenerTodasLasEstrellas(Model model) {
		log.info("obtenerTodasLasEstrellas");
	...
	public String eliminarEstrellaById(Model model, @PathVariable("id") Long id) throws RecordNotFoundException {
