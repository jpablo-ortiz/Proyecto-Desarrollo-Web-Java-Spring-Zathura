...
public class DatabaseInit implements ApplicationRunner {
        ...
        public void creacionEstrellas() {
                ...
                for (int i = 0; i < totalEstrellas; i++) {
                        if (random.nextInt(2) == 1 && estrellasHabitadas > 0) {
                                ...
                                estrella = estrellaRepository.save(new Estrella(randomGen.generate(5, 10),
                                                random.nextInt(2000), random.nextDouble(), random.nextDouble(),
                                                random.nextDouble(), false));
                                estrellas.add(estrella);
                        }
        ...
        public void creacionProductos() {
                ...
                for (Planeta planetas : planetaRepository.findAll()) {
                        ...
                        for (int i = 0; i < cantidadProductos; i++) {
                                ...
                                planetaXProductoRepository.save(new PlanetaXProducto(random.nextDouble(),
                                                random.nextDouble(), random.nextDouble() * 100 + 1,
                                                random.nextDouble() * 100 + 1, random.nextInt(100001), planetas,
        ...
        public void creacionModelosNave() {
                ...
                for (int i = 0; i < 10; i++) {
                        ...
                        planeta = planetaRepository.findById((long) ranPlaneta).orElse(null);
                        nave = naveRepository.save(new Nave(nombreNave, random.nextDouble(), random.nextDouble(),
                                        costoR, planeta, mod));
                        for (int j = 0; j < random.nextInt(10); j++) {
                                ...
                                naveXProductoRepository.save(new NaveXProducto(random.nextDouble(), random.nextDouble(),
                                                random.nextDouble(), nave, prod));
                        }
                        ...
                        for (int j = 0; j < 3; j++) {
                                ...
                                if (ran == 0)
                                        tripulanteRepository.save(new Tripulante(randomGen.generate(5, 10),
                                                        randomGen.generate(5, 10), true, false, false, nave));
                                if (ran == 1)
                                        tripulanteRepository.save(new Tripulante(randomGen.generate(5, 10),
                                                        randomGen.generate(5, 10), false, true, false, nave));
                                if (ran == 2)
                                        tripulanteRepository.save(new Tripulante(randomGen.generate(5, 10),
                                                        randomGen.generate(5, 10), false, false, true, nave));
                        }
        ...
        public void generarEntrega2() throws RecordNotFoundException {
                ...
                List<Estrella> estrellas = new ArrayList<Estrella>();
                // Crear Estrelllas
                Estrella estrella1 = new Estrella("Estrella 1", Double.valueOf(123), Double.valueOf(432),
                                Double.valueOf(575), Boolean.valueOf(true));
                estrella1 = estrellaController.crearEstrella(estrella1);
                estrellas.add(estrella1);

                Estrella estrella2 = new Estrella("Estrella 2", Double.valueOf(742), Double.valueOf(1),
                                Double.valueOf(999), Boolean.valueOf(true));
                estrella2 = estrellaController.crearEstrella(estrella2);
                estrellas.add(estrella2);

                Estrella estrella = new Estrella("Estrella 3", Double.valueOf(543), Double.valueOf(876),
                                Double.valueOf(123), Boolean.valueOf(true));
                estrella = estrellaController.crearEstrella(estrella);
                estrellas.add(estrella);

                Estrella estrella3 = new Estrella("Estrella 4", Double.valueOf(111), Double.valueOf(325),
                                Double.valueOf(876), Boolean.valueOf(true));
                ...
                ModeloNave modeloNave = new ModeloNave(Long.valueOf(1), "Cuchao", Double.valueOf(500),
                                Double.valueOf(500), (double) 50);
                ...
                Producto producto1 = new Producto(Long.valueOf(1), "Producto 1", Double.valueOf(500),
                                Double.valueOf(100), Double.valueOf(100));
                producto1 = productoController.crearProducto(producto1);

                Producto producto2 = new Producto(Long.valueOf(2), "Producto 2", Double.valueOf(300),
                                Double.valueOf(200), Double.valueOf(800));
                producto2 = productoController.crearProducto(producto2);

                Producto producto3 = new Producto(Long.valueOf(3), "Producto 3", Double.valueOf(100),
                                Double.valueOf(600), Double.valueOf(50));
                producto3 = productoController.crearProducto(producto3);

                Producto producto4 = new Producto(Long.valueOf(4), "Producto 4", Double.valueOf(900),
                                Double.valueOf(50), Double.valueOf(10));
                producto4 = productoController.crearProducto(producto4);

                Producto producto5 = new Producto(Long.valueOf(5), "Producto 5", Double.valueOf(500),
                                Double.valueOf(100), Double.valueOf(100));
                producto5 = productoController.crearProducto(producto5);

                NaveXProducto naveXProducto = new NaveXProducto(Long.valueOf(1), Double.valueOf(500),
                                Double.valueOf(500), Double.valueOf(1000));
