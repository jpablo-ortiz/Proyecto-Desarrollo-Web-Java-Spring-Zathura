...
public class ModeloNaveControllerIntegrationTest {
    ...
    void obtenerModeloNave(){
        ModeloNave modeloNave = rest.getForObject("http://localhost:" + port + "/modelo-nave/12", ModeloNave.class);
    ...
    void buscarModelosNave() {
        List<ModeloNave> modeloNaves = rest.getForObject("http://localhost:" + port + "/modelo-nave", ArrayList.class);
