...
public class ProductoControllerIntegrationTest {
    ...
    @Test
    void buscarProducto() {
        Producto producto = rest.getForObject("http://localhost:" + port + "/producto/16", Producto.class);
        assertEquals(16, producto.getId());
    }

    @Test
    void buscarProductos() {
        List<Producto> productos = rest.getForObject("http://localhost:" + port + "/producto", ArrayList.class);
