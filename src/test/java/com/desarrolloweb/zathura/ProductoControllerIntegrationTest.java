...
public class ProductoControllerIntegrationTest {
    ...
    @Test
    void buscarProducto() {
        Producto producto = rest.withBasicAuth("usuario1", "1234")
                .getForObject("http://localhost:" + port + "/producto/16", Producto.class);
    ...
    void buscarProductos() {
        List<Producto> productos = rest.withBasicAuth("usuario1", "1234")
                .getForObject("http://localhost:" + port + "/producto", ArrayList.class);
