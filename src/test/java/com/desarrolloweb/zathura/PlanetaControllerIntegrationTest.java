...
public class PlanetaControllerIntegrationTest {
    ...
    void init() {
        ...
        Estrella estrella2 = new Estrella("estrella2", Double.valueOf(23), Double.valueOf(47), Double.valueOf(52),true);
        Estrella estrella3 = new Estrella("estrella3", Double.valueOf(42), Double.valueOf(49), Double.valueOf(56),true);
        Estrella estrella4 = new Estrella("estrella4", Double.valueOf(67), Double.valueOf(42), Double.valueOf(59),true);
        Estrella estrella5 = new Estrella("estrella5", Double.valueOf(12), Double.valueOf(34), Double.valueOf(45),true);
        Estrella estrella6 = new Estrella("estrella6", Double.valueOf(23), Double.valueOf(47), Double.valueOf(52),true);
        Estrella estrella7 = new Estrella("estrella7", Double.valueOf(42), Double.valueOf(49), Double.valueOf(56),true);
        Estrella estrella8 = new Estrella("estrella8", Double.valueOf(67), Double.valueOf(42), Double.valueOf(59),true);
        Estrella estrella9 = new Estrella("estrella9", Double.valueOf(12), Double.valueOf(34), Double.valueOf(45),true);
        Estrella estrella10 = new Estrella("estrella10", Double.valueOf(23), Double.valueOf(47), Double.valueOf(52),true);
        ...
        PlanetaXProducto planetaXProducto1 = new PlanetaXProducto(Double.valueOf(100),Double.valueOf(100),Double.valueOf(100),Double.valueOf(100), Integer.valueOf(100), planeta1,producto1);
        planetaXProductoRepository.save(planetaXProducto1);//id18
    ...
    @Test
    void obtenerPlaneta(){
        Planeta planeta = rest.getForObject("http://localhost:" + port + "/planeta/11", Planeta.class);
        assertEquals(11,planeta.getId());
    }


    @Test
    void obtenerPlanetas() {
        List<Planeta> planetas = rest.getForObject("http://localhost:" + port + "/planeta", ArrayList.class);
        assertEquals(2, planetas.size());
    }

    @Test
    void obtenerPlanetasPorEstrella() {
        List<Planeta> planetas = rest.getForObject("http://localhost:" + port + "/planeta/estrella/1", ArrayList.class);
        assertEquals(2, planetas.size());
    }

    @Test
    void obtenerProductosPorPlaneta() {
        List<Producto> productos = rest.getForObject("http://localhost:" + port + "/planeta/productos/11", ArrayList.class);
        assertEquals(1, productos.size());
    }

    @Test
    void obtenerPlanetaXProducto() {
        PlanetaXProducto pxp = rest.getForObject("http://localhost:" + port + "/planeta/11/producto/16", PlanetaXProducto.class);
        assertEquals(18, pxp.getId());
    }
